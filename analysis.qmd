...
ny_top_complaints_plot<- monthly_counts |>
  ...
  geom_line() +
  labs(title = "Top 5 Complaints From Constituents Over Time", subtitle = "NYC Council Office District Data", x = "Date Complaint Opened", y = "Count", color = "Complaint Type") +
